...
public abstract class NBTUtil {
  ...
  /**
   * Uses NMS to get NBT data from an {@link org.bukkit.inventory.ItemStack ItemStack}, then checks
   * if it has the provided key.
   *
   * @param item The item to check.
   * @param key The key to check for.
   * @return <code>true</code> if the item has an NBT Compound and the given key, <code>false</code>
   *     otherwise.
   */
   ...
   * @param item The item to check.
   * @param key The key to check for.
   * @return <code>true</code> if the item has an NBT Compound and a Byte with the given key, <code>
   ...
   * @param item The item to check.
   * @param key The key to check for.
   * @return <code>true</code> if the item has an NBT Compound and a Long with the given key, <code>
   *     false</code> if otherwise.
   */
   ...
   * @param item The item to check.
   * @param key The key to check for.
   * @return The value of the Integer Array with the given key if the item has an NBT Compound with
   *     that key, <code>null</code> if otherwise.
   */
   ...
   * @param key The key to check for.
   * @return The value of the Integer Array with the given key if the item has an NBT Compound with
   *     that key, an empty Integer Array if otherwise.
   */
