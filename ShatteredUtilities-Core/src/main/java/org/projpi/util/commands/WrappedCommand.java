...
public abstract class WrappedCommand extends SimpleCommandExecutor implements TabCompleter, CommandExecutor
{
    ...
    public WrappedCommand(Messageable instance, WrappedCommand parent, String label, String permission,
                          String helpPath)
    {
        this.parent = parent;
    ...
    public boolean onCommand(CommandSender sender, String label, String[] args)
    {
        ...
        {
            children.get(args[0]).onCommand(sender, label + " " + args[0], Arrays.copyOfRange(args, 1, args.length));
        }
        return true;
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args)
    {
        ...
        return children.containsKey(args[0]) ? children.get(args[0])
                .onTabComplete(sender, command, alias + " " + args[0], Arrays.copyOfRange(args, 1, args.length)) :
                null;
    }
